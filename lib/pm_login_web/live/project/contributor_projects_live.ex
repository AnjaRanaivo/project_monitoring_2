defmodule PmLoginWeb.Project.ContributorProjectsLive do
  use Phoenix.LiveView
  alias PmLogin.Services

  def mount(_params, %{"curr_user_id"=>curr_user_id, "projects" => projects}, socket) do
    Services.subscribe()

    {:ok,
       socket
       |> assign(projects: projects,curr_user_id: curr_user_id, show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4)),
  ...
  def render(assigns) do
   PmLoginWeb.ContributorView.render("my_projects.html", assigns)
  end
end
