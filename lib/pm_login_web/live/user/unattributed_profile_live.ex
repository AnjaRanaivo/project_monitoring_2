defmodule PmLoginWeb.User.UnattributedProfileLive do
  ...
  def mount(_params, %{"curr_user_id" => curr_user_id, "user" => user}, socket) do
    ...
    {:ok,
       socket
       |> assign(user: user, curr_user_id: curr_user_id, show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4)),
  ...
  def render(assigns) do
   PmLoginWeb.UserView.render("show.html", assigns)
  end
