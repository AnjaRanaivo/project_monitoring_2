defmodule PmLoginWeb.User.ActiveClientDemandeurLive do
  ...
  def mount(_params, %{"curr_user_id"=>curr_user_id, "current_user" => current_user}, socket) do
    ...
    {:ok,
       ...
       layout: {PmLoginWeb.LayoutView, "active_client_demandeur_layout_live.html"}
       }
  end
  ...
  def render(assigns) do
   PmLoginWeb.UserView.render("active_client_demandeur_index.html", assigns)
  end
