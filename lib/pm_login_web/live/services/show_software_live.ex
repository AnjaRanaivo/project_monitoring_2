defmodule PmLoginWeb.Services.ShowSoftwareLive do
  use Phoenix.LiveView
  alias PmLogin.Services
  alias PmLogin.Services.Company

  def mount(_params, %{"curr_user_id"=>curr_user_id, "software" => software}, socket) do
    Services.subscribe()

    {:ok,
       socket
       |> assign(curr_user_id: curr_user_id,show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4), software: software),
  ...
  def render(assigns) do
   PmLoginWeb.SoftwareView.render("show.html", assigns)
  end
