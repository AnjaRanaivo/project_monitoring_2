defmodule PmLoginWeb.Company.IndexLive do
  ...
  def mount(_params, %{"curr_user_id" => curr_user_id}, socket) do
    ...
    {:ok,
       socket
       |> assign(curr_user_id: curr_user_id, show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4), companies: Services.list_companies),
  ...
  def render(assigns) do
   PmLoginWeb.CompanyView.render("index.html", assigns)
  end
