defmodule PmLoginWeb.Company.EditLive do
  ...
  def mount(_params, %{"curr_user_id" => curr_user_id, "changeset" => changeset, "company" => company}, socket) do
    ...
    {:ok,
       socket
       |> assign(changeset: changeset, company: company,curr_user_id: curr_user_id, show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4)),
  ...
  def render(assigns) do
   PmLoginWeb.CompanyView.render("edit.html", assigns)
  end
end
