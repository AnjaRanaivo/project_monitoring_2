defmodule PmLoginWeb.Company.ShowLive do
  ...
  def mount(_params, %{"curr_user_id" => curr_user_id, "company_id" => company_id}, socket) do
    ...
    {:ok,
       socket
       |> assign(company: company,curr_user_id: curr_user_id, show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4)),
  ...
  def render(assigns) do
   PmLoginWeb.CompanyView.render("show.html", assigns)
  end
end
