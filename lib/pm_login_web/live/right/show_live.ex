defmodule PmLoginWeb.Right.ShowLive do
  use Phoenix.LiveView
  alias PmLogin.Services

  def mount(_params, %{"curr_user_id" => curr_user_id,"right" => right}, socket) do
    Services.subscribe()

    {:ok,
       socket
       |> assign(right: right,curr_user_id: curr_user_id, show_notif: false, notifs: Services.list_my_notifications_with_limit(curr_user_id, 4)),
  ...
  def render(assigns) do
   PmLoginWeb.RightView.render("show.html", assigns)
  end
